...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_staff'])) {
    ...
    if (!empty($_FILES['photo']['name'])) {
        ...
        if (in_array($ext, $allowed) && $_FILES['photo']['size'] < 2097152) {
            ...
            $message = 'Érvénytelen kép formátum vagy méret (max 2MB)!';
            $message_type = 'error';
        }
    }
...
<!-- ── LISTA + FORM ── -->
<div class="page-header">
    <h2><i class="fas fa-hand-sparkles"></i> Műkörmösök kezelése</h2>
...
<div class="modal-overlay" id="staffModal">
    <div class="modal" style="max-width:700px;">
        <div class="modal-header">
            <h3 id="modalTitle"><i class="fas fa-hand-sparkles"></i> Műkörmös hozzáadása</h3>
...
function openStaffModal(staff = null, services = []) {
    document.getElementById('modalTitle').innerHTML =
        staff ? '<i class="fas fa-edit"></i> Műkörmös szerkesztése' : '<i class="fas fa-hand-sparkles"></i> Műkörmös hozzáadása';
